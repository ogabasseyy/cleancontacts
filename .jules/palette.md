...
## 2026-05-31 - Consistent Tactile Feedback on CTAs
**Learning:** Adding subtle scaling interactions on primary CTA buttons ensures consistent tactile feedback, enhancing the micro-UX parity across the application.
**Action:** Always apply `active:scale-95 transition-all duration-200` to primary Call-to-Action buttons alongside hover states in the design system to provide a cohesive, responsive interaction.
