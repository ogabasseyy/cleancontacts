...
class ContactRepositoryImpl constructor(
    ...
    override suspend fun refreshContacts(contacts: List<Contact>): Boolean {
        ...
        try {
            ...
            // 3. Update DB
            // ⚡ Bolt Optimization: Use HashSet for O(1) lookups and single-pass iteration
            // to eliminate O(N*M) lag and intermediate collection allocations.
            ...
            for (i in existingContacts.indices) {
                ...
                if (contact.id !in returnedIds && contact.id !in idSet) {
