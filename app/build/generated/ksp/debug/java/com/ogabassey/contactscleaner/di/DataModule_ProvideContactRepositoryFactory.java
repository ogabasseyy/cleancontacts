...
public final class DataModule_ProvideContactRepositoryFactory implements Factory<ContactRepository> {
  ...
  public ContactRepository get() {
    return provideContactRepository(contactDaoProvider.get(), contactsProviderSourceProvider.get(), junkDetectorProvider.get(), duplicateDetectorProvider.get(), formatDetectorProvider.get(), scanResultProvider.get());
  }
  ...
  public static DataModule_ProvideContactRepositoryFactory create(
      ...
      Provider<FormatDetector> formatDetectorProvider,
      Provider<ScanResultProvider> scanResultProvider) {
    return new DataModule_ProvideContactRepositoryFactory(contactDaoProvider, contactsProviderSourceProvider, junkDetectorProvider, duplicateDetectorProvider, formatDetectorProvider, scanResultProvider);
  }
  ...
  public static ContactRepository provideContactRepository(ContactDao contactDao,
    ...
    return Preconditions.checkNotNullFromProvides(DataModule.INSTANCE.provideContactRepository(contactDao, contactsProviderSource, junkDetector, duplicateDetector, formatDetector, scanResultProvider));
  }
}
