...
public final class ResultsViewModel_Factory implements Factory<ResultsViewModel> {
  ...
  public ResultsViewModel get() {
    return newInstance(getContactsPagedUseCaseProvider.get(), cleanupContactsUseCaseProvider.get(), scanResultProvider.get(), contactRepositoryProvider.get(), billingRepositoryProvider.get(), formatDetectorProvider.get(), exportUseCaseProvider.get(), undoUseCaseProvider.get());
  }
  ...
  public static ResultsViewModel_Factory create(
      ...
      Provider<FormatDetector> formatDetectorProvider,
      Provider<ExportUseCase> exportUseCaseProvider, Provider<UndoUseCase> undoUseCaseProvider) {
    return new ResultsViewModel_Factory(getContactsPagedUseCaseProvider, cleanupContactsUseCaseProvider, scanResultProvider, contactRepositoryProvider, billingRepositoryProvider, formatDetectorProvider, exportUseCaseProvider, undoUseCaseProvider);
  }
  ...
  public static ResultsViewModel newInstance(GetContactsPagedUseCase getContactsPagedUseCase,
    ...
    return new ResultsViewModel(getContactsPagedUseCase, cleanupContactsUseCase, scanResultProvider, contactRepository, billingRepository, formatDetector, exportUseCase, undoUseCase);
  }
}
