            ...
            {posts.map(post => (
              ...
              >
                ...
                <div className="mt-4 flex flex-wrap items-center justify-between gap-4">
                  ...
                  <span className="flex items-center gap-2 text-sm font-medium text-brand opacity-0 translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 group-focus-visible:opacity-100 group-focus-visible:translate-x-0 transition-all duration-300">
                    Read article
