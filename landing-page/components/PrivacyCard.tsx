    ...
    <div className="glass-panel backdrop-blur-xl rounded-3xl p-8 md:p-12 shadow-2xl animate-in fade-in zoom-in duration-300">
      ...
      <div className="prose prose-invert max-w-none prose-headings:font-bold prose-p:text-gray-400 prose-strong:text-brand prose-a:text-brand">
        ...
        <section className="mb-12">
          ...
          <ol className="space-y-3 not-prose list-none p-0">
        ...
        <section className="mt-16 pt-12 border-t border-white/10">
          ...
          <a 
            ...
            className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-brand/10 border border-brand/30 text-brand hover:bg-brand/20 active:scale-95 transition-all duration-200 font-semibold no-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-dark"
          >
