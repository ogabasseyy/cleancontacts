...
export const Security: React.FC = () => {
  return (
    <section id="security" className="py-20 border-t border-white/5 bg-[#080808] scroll-mt-32" aria-labelledby="security-heading">
      <div className="container mx-auto px-6 text-center">
        <div className="max-w-3xl mx-auto mb-12">
          <div className="w-16 h-16 bg-white/5 rounded-2xl mx-auto flex items-center justify-center mb-6">
             <svg className="w-8 h-8 text-brand" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" focusable="false"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
          </div>
          <h2 id="security-heading" className="text-3xl font-bold mb-4">Your Contacts Stay on Your Device</h2>
