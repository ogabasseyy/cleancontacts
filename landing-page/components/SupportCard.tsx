      ...
      <link rel="canonical" href="https://contactscleaner.tech/support" />
       <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-brand/20 text-brand mb-6">
             <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" ><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
          </div>
       ...
       <ul className="grid gap-6 mb-12 list-none p-0 m-0">
          <li className="p-6 rounded-2xl bg-white/5 border border-white/5 hover:border-brand/30 transition-colors">
       ...
       <div className="p-8 rounded-2xl bg-brand/5 border border-brand/10 text-center">
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-brand text-black hover:bg-white transition-all duration-200 active:scale-95 font-bold text-lg shadow-lg shadow-brand/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-dark"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" ><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
            Contact Support
          </a>
       </div>
    </div>
