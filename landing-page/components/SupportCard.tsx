      ...
      <link rel="canonical" href="https://contactscleaner.tech/support" />
       ...
       <div className="p-8 rounded-2xl bg-brand/5 border border-brand/10 text-center">
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-brand text-black hover:bg-white active:scale-95 transition-all duration-200 font-bold text-lg shadow-lg shadow-brand/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-dark"
          >
