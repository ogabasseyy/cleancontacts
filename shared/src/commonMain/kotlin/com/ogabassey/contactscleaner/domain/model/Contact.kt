...
@Serializable
enum class JunkType {
    NO_NAME, NO_NUMBER, SUSPICIOUS_NUMBER, REPETITIVE_DIGITS, SYMBOL_NAME, INVALID_CHAR, LONG_NUMBER, SHORT_NUMBER, NUMERICAL_NAME, EMOJI_NAME, FANCY_FONT_NAME, LONG_NAME
}
