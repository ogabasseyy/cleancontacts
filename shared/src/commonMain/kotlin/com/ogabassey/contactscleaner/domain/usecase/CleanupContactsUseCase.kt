...
class CleanupContactsUseCase(
    ...
    suspend fun deleteByIds(ids: List<Long>): Boolean {
        ...
        // ⚡ Bolt Optimization: O(1) hash lookup and single-pass ArrayList allocation
        // prevents O(N*M) time complexity and intermediate collection allocation.
        val idSet = ids.toHashSet()
        val contactsToDelete = ArrayList<com.ogabassey.contactscleaner.domain.model.Contact>(ids.size)
